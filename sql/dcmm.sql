...
CREATE TABLE `items` (
  ...
  `TableIndex` int(10) DEFAULT NULL,
  `InventoryIndex` int(11) DEFAULT NULL,
  `UpgradePoint` int(10) DEFAULT '0',
  `Upgrade` int(10) DEFAULT '0',
  `Belonging` int(10) DEFAULT '0',
  `Box` int(10) DEFAULT '0',
  `AssistJ` int(10) DEFAULT '0',
  `AssistI` int(10) DEFAULT '0',
  `AssistH` int(10) DEFAULT '0',
  `AssistG` int(10) DEFAULT '0',
  `AssistF` int(10) DEFAULT '0',
  `AssistE` int(10) DEFAULT '0',
  `AssistD` int(10) DEFAULT '0',
  `AssistC` int(10) DEFAULT '0',
  `AssistB` int(10) DEFAULT '0',
  `AssistA` int(10) DEFAULT '0',
