...
namespace Shared.Network
{
    public class DefaultServer
    {
        ...
        public void Parse(Packet packet)
        {
            ...
            if (packet.Id != Packets.CmdUnknownSync /*3917*/ && packet.Id != Packets.CmdNullPing /*7*/ &&
                packet.Id != 706 && packet.Id != 707 && packet.Id != Packets.CmdUdpCastTcs /*702*/)
